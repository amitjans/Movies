movies.controller('directores', ['$scope', '$http', function ($scope, $http) {
  ...
  $scope.create = function () {
    $http.post('/api/directores', '{ "nombre": "' + $scope.nombre + '", "nacionalidad": "' + $scope.nacionalidad + '" }').then(function successCallback(response) {
      $scope.nombre = '';
      $scope.nacionalidad = '';
      $scope.list();
    }, function errorCallback(response) {
  ...
  $scope.updatesend = function () {
    $http.put('/api/directores/' + $scope.updateid, '{ "nombre": "' + $scope.nombre + '", "nacionalidad": "' + $scope.nacionalidad + '" }').then(function successCallback(response) {
      $scope.updateid = '';
      $scope.accion = 'Agregar';
      $scope.icon = true;
      $scope.descripcion = '';
  ...
  $scope.delete = function (id) {
    $http.delete('/api/directores/' + id).then(function successCallback(response) {
